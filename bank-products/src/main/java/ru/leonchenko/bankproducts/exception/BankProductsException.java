package ru.leonchenko.bankproducts.exception;

import com.fasterxml.jackson.annotation.JsonIgnoreProperties;
import lombok.Getter;
import org.springframework.http.HttpStatus;
import org.springframework.http.HttpStatusCode;
import ru.leonchenko.bankproducts.enums.BankProductsErrors;
...
public class BankProductsException extends RuntimeException {
    ...
    public BankProductsException(HttpStatus status, String uuid, String time, String code, String message, Throwable cause) {
        super(message, cause);
        this.status = status;
        this.uuid = uuid;
        this.time = time;
    ...
    public BankProductsException(BankProductsErrors error) {
    ...
    public BankProductsException(BankProductsErrors error, HttpStatusCode status) {
    ...
    public BankProductsException(BankProductsErrors error, String uuid) {
    ...
    public BankProductsException(BankProductsErrors error, Throwable ex) {
